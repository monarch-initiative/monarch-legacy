...
function tableSortDataType(name) {
    var string_types = ["allele", "association type", "disease", "similar diseases",
        ...
        "mutation", "object", "onset", "organism", "other matching phenotypes", "pathway", "phenotype",
...
function genTableOfLiterature(assocs) {
    ...
    return genTable(
        {
            columns: [
                ...
                {name: "PMID Info",
                    val: function(a) {return JSON.stringify(a.pubinfo)}
                },
            ]
        },
        assocs);

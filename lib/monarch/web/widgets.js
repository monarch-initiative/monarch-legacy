...
function genTableOfGeneAlleleAssociations (assocs) {
    return genTable({
        ...
        columns: [
            ...
            {name: "type",
            	val: function(a){ return convChars(a.variant.variant_type.label) } //convChars(a.variant.type)  }
            },
            {name: "evidence",
                val: function(a){ return genExternalHref('references', a.references) }
            },
...
function sourceImage(source) {
    ...
    if (source == null || source == "") {
        ...
        image = '<img class="source" src="../image/source-coriell.jpg"/>';
    ...
    } else if (source.match(/PubMed|NCBI|PMID|pmid/)) {

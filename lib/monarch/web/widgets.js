    ...
    return genTable(
        {
            columns: [
                {name: "category",
                 val: function(a){ return convChars(a.categories) }
                },
                {name: "term",
                 val: function(a){ return genObjectHref(a.categories, a) }
                },
                {name: "taxon",

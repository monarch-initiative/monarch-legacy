    ...
    return genTable(
        {
            columns: [
                {name: "Category",
                 val: function(a){ return a.category }
                },
                {name: "Term",
    ...
    return genTable(
        {
            columns: [
                ...
                {name: "combined score",
                 val: function(a){ return a.combinedScore }
                },
                {name: "SimGIC",
                 val: function(a){ return a.simGIC }
                },
    ...
    return genTable(
        {
            columns: [
                ...
                {name: "mutation",
                 val: function(a){ return a.sequence_alteration.has_mutation }
                },
                {name: "allele",
    ...
    return genTable(
        {   
            columns: [
                ...
                {name: "metric",
                 val: function(a){ return a.b.score.metric }
                },
                {name: "score",
                 val: function(a){ return a.b.score.score }
                },
                {name: "rank",
                 val: function(a){ return a.b.score.rank }
                },
            ]   
        },       
        unnestedAssocs);

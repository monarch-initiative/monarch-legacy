                 ...
                 val: function(a){ 
                     if (a.has_phenotype.start_stage != null) {
                         if (a.has_phenotype.start_stage.id == a.has_phenotype.end_stage.id) {
                             return genObjectHref('stage', a.has_phenotype.start_stage.type);
                         }
                         else {
                             return genObjectHref('stage', a.has_phenotype.start_stage.type) + " " + genObjectHref('stage', a.has_phenotype.end_stage.type);
                         }
                     } 
                     else {
                         return "";

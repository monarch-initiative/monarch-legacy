...
function genPhenoGraph(dataGraph) {
     var content = '<script type="text/javascript">'+
                   ...
                   'var minWidth = phenoGraph.width + phenoGraph.margin.left + phenoGraph.margin.right + 20;' +
                   ...
                   '.css( {"width" : minWidth+"px", "height" : minHeight+110+"px"});'+
...
function genDiseaseGraph(dataGraph) {
     var content = '<script type="text/javascript">'+
                   'jQuery(document).ready(function(){' +
                   'var disGraph = jQuery.extend(true, {}, datagraph);'+
                   'var data=' + JSON.stringify(dataGraph) +';'+
                   'disGraph.height=240;' +
                   'disGraph.chartTitle = "Gene Annotation Distribution";' +
                   'disGraph.firstCrumb = "Anatomical Entity";' +
                   'disGraph.xAxisLabel= "Number Of Genes";' +
                   'disGraph.useLegend= false;' +
                   'disGraph.yLabelBaseURL= \"/disease/\";' +
                   'var minWidth = disGraph.width + disGraph.margin.left + disGraph.margin.right + 20;' +
...
function genDiseasePhenoGraph(dataGraph) {
     var content = '<script type="text/javascript">'+
                   'jQuery(document).ready(function(){' +
                   'var disPhenoGraph = jQuery.extend(true, {}, datagraph);'+
                   'var data=' + JSON.stringify(dataGraph) +';'+
                   'disPhenoGraph.height=240;' +
                   'disPhenoGraph.chartTitle = "Disease Annotation Distribution";' +
                   'disPhenoGraph.firstCrumb = "Anatomical Entity";' +
                   'disPhenoGraph.useLegend= false;' +
                   'disPhenoGraph.yLabelBaseURL= \"/disease/\";' +
                   'var minWidth = disPhenoGraph.width + disPhenoGraph.margin.left + disPhenoGraph.margin.right + 20;' +
...
function genPhenoGenoGraph(dataGraph) {
     var content = '<script type="text/javascript">'+
                   'jQuery(document).ready(function(){' +
                   'var genoGraph = jQuery.extend(true, {}, datagraph);'+
                   'var data=' + JSON.stringify(dataGraph) +';'+
                   'genoGraph.height=340;' +
                   'genoGraph.chartTitle = "Genotype Annotation Distribution";' +
                   'genoGraph.xAxisLabel= "Number Of Genotypes";' +
                   'genoGraph.color.first = "#A4D6D4";' +
                   'var minWidth = genoGraph.width + genoGraph.margin.left + genoGraph.margin.right + 20;' +
...
function genPhenoGeneGraph(dataGraph) {
    var content = '<script type="text/javascript">'+
                  'jQuery(document).ready(function(){' +

...
app.get('/labs/datagraph.:fmt?',function(request,fmt){
       ...
       /* var phenoGeneDist = engine.getPhenotypeGenotypeDistro(
        ...
        var disPhenoDist = JSON.parse(fs.read('./widgets/dove/stats/key-disease-phenotype-distro.json'));
        var phenoGenoDist = JSON.parse(fs.read('./widgets/dove/stats/key-pheno-genotype-distro.json'));
        //var phenoGeneDist = JSON.parse(fs.read('./widgets/dove/stats/key-pheno-gene-distro.json'));
        ...
        [
            ...
            {name:'diseaseDist',value:diseaseDist},
            {name:'disPhenoDist',value:disPhenoDist},
            {name:'phenoGenoDist',value:phenoGenoDist}
        ]);
        info.monarch_launchable = [];

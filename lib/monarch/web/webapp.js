...
app.get('/', function(request) {
    ...
    var output = pup_tent.render('main.mustache',info);
...
app.get('/search/:term?.:fmt?', function(request, term, fmt) {
    try {
        ...
        var output = pup_tent.render('search_results.mustache',info);
        return response.html(output);    
    }
    catch(err) {
...
app.get('/labs/datagraph.:fmt?',function(request,fmt){
	    ...
	    var output = pup_tent.render('datagraph.mustache',info);
	    return response.html(output);
    });

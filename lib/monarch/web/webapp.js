...
function diseaseByIdHandler(request, id, fmt) {
    ...
    addGolrTable(info, 'object_closure', 'gene-causal-table', gene_filter, 'gene_disease','#gene-causal');
...
function geneByIdHandler(request, id, fmt) {
  console.log('geneByIdHandler', id, fmt);
    try {
        ...
        addGolrTable(info, 'subject_closure', 'disease-causal-table', disease_filter, 'gene_disease','#disease-causal');

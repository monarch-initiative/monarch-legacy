...
app.get('/disease', function(request) {
 ...
 app.get('/disease_genes/:id', function(request, id, fmt) {
     engine.log("getting /disease_genes/:id where id="+id);
     ...
     info.geneTable = function() {
         return genTableOfDiseaseGeneAssociations(info.gene_associations);
     };

     var output = pup_tent.render('disease_genes.mustache',info);
     return response.html(output);
 ...
 app.get('/disease_phenotype/:id', function(request, id, fmt) {
     engine.log("getting /disease_phenotype/:id where id="+id);
     var newId = engine.resolveClassId(id);
     if (newId != id) {
         engine.log("redirecting: "+id+" ==> "+newId);
         return response.redirect(genURL('disease',newId));
     ...
     info.phenotypeTable = function() {
         return genTableOfDiseasePhenotypeAssociations(info.phenotype_associations);
     };

     var output = pup_tent.render('disease_phenotype.mustache',info);
     return response.html(output);
 });

 // DISEASE PAGE
 // Status: working but needs work
 app.get('/disease_alleles/:id', function(request, id, fmt) {
     engine.log("getting /disease_alleles/:id where id="+id);
     var newId = engine.resolveClassId(id);
     if (newId != id) {
         engine.log("redirecting: "+id+" ==> "+newId);
         return response.redirect(genURL('disease',newId));
     ...
     info.alleleTable = function() {
         return genTableOfDiseaseAlleleAssociations(info.alleles);
     };

     var output = pup_tent.render('disease_alleles.mustache',info);
     return response.html(output);
 });

 // DISEASE PAGE
 // Status: working but needs work
 app.get('/disease_pathways/:id', function(request, id, fmt) {
     engine.log("getting /disease_pathways/:id where id="+id);
     var newId = engine.resolveClassId(id);
     if (newId != id) {
         engine.log("redirecting: "+id+" ==> "+newId);
         return response.redirect(genURL('disease',newId));
     ...
     info.pathwayTable = function() {
         return genTableOfDiseasePathwayAssociations(info.pathway_associations);
     };

     var output = pup_tent.render('disease_pathways.mustache',info);
     return response.html(output);
 });

 // DISEASE PAGE
 // Status: working but needs work
 app.get('/disease_literature/:id', function(request, id, fmt) {
     engine.log("getting /disease_literature/:id where id="+id);
     var newId = engine.resolveClassId(id);
     if (newId != id) {
         engine.log("redirecting: "+id+" ==> "+newId);
         return response.redirect(genURL('disease',newId));
     ...
     info.literatureTable = function() {
         return genTableOfLiterature(info.literature, info.pmidinfo);
     };

     var output = pup_tent.render('disease_literature.mustache',info);
     return response.html(output);
 });

 // DISEASE PAGE
 // Status: working but needs work
 app.get('/disease_similarity/:id', function(request, id, fmt) {
     engine.log("getting /disease_similarity/:id where id="+id);
     var newId = engine.resolveClassId(id);
     if (newId != id) {
         engine.log("redirecting: "+id+" ==> "+newId);
         return response.redirect(genURL('disease',newId));
     ...
     info.simTable = function() {
         return genTableOfSimilarDiseases(info.similar_diseases);
     };

     var output = pup_tent.render('disease_similarity.mustache',info);
     return response.html(output);
 });

 // disease page
 // status: working but needs work
 app.get('/disease_models/:id', function(request, id, fmt) {
     engine.log("getting /disease_models/:id where id="+id);
     var newid = engine.resolveclassid(id);
     if (newid != id) {
         engine.log("redirecting: "+id+" ==> "+newid);
         return response.redirect(genurl('disease',newid));
     ...
     info.modelTable = function() {
         return genTableOfDiseaseModelAssociations(info.models);
     };

     var output = pup_tent.render('disease_models.mustache',info);
     return response.html(output);
 });
...
app.get('/labs/datagraph.:fmt?',function(request,fmt){
       ...
       /* var phenoGeneDist = engine.getPhenotypeGenotypeDistro(
        ...
        info.disPhenoGraph = function() {return genDiseasePhenoGraph(disPhenoDist.dataGraph)};
        info.phenoGenoGraph = function() {return genPhenoGenoGraph(phenoGenoDist.dataGraph)};
        //info.phenoGeneGraph = function() {return genPhenoGeneGraph(phenoGeneDist.dataGraph)};

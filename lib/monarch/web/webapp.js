...
function diseaseLandingHandler(request) {
    ...
    if (request.query.spa === '1') {
      info.includes.navbar = '';
      console.log('info', info);
      var output = pup_tent.render('disease_main.mustache', info, 'spa_base.mustache');
    }
    else {
...
function homeHandler(request) {
  ...
  if (request.query.spa === '1') {
    info.includes.navbar = '';
    var output = pup_tent.render('home-page.mustache', info, 'spa_base.mustache');
  }
  else {
...
function geneByIdHandler(request, id, fmt) {
    try {
        ...
        addGolrTable(info, 'subject_ortholog_closure', 'ortholog-disease-table', ortho_disease_filter,
                'gene_phenotype','#ortholog-diseases', false);

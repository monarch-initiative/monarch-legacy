...
//Example: /phenoHPO/HP_0003273/2/out/subClassOf.json
app.get('/phenoHPO/:id/:depth/:direction/:relationship.:fmt?', function(request, id, depth, direction, relationship, fmt) {

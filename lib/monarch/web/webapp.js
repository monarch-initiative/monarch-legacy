...
function variantByIdHandler(request, id, fmt) {
    try {
        ...
        //Launch function for annotation score
        info.pup_tent_js_variables.push({name:'entityID',value:id});

        info.monarch_launchable.push('getAnnotationScore(entityID)');
        info.monarch_launchable.push('createMyVariantTable(entityID)');

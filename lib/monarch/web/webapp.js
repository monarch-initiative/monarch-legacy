...
if (useSPA) {
  function computeCounts(info, nodetype, id) {
    ...
    const functionFilters = {
      gene: [
                  'object',
                  { field: 'association_type', value: 'gene_function' },
                  { field: 'subject_closure', value: id }
               ],
...
function addHomologTable() {
    var homologs_table = {href: "homologs", div: "homolog-table", filter: false};
...
function addAnatomyTable() {
 ...
 function addGeneCausalTable() {
     const gene_table = {
         href: 'gene-causal', div: 'gene-causal-table', filter: true
     };
     return expandTemplate('golr-table', gene_table);
 }
 ...
 function addGeneOtherTable() {
     const gene_table = {
         href: 'gene-other', div: 'gene-other-table', filter: true
     };
     return expandTemplate('golr-table', gene_table);
 }

...
function phenotypeByIdHandler(request, id, fmt){
            ...
            info.pup_tent_js_variables.push({name:'global_scigraph_url',
                value: engine.config.scigraph_url});
            info.pup_tent_js_variables.push({name:'globalID',value:id});
            info.pup_tent_js_variables.push({name:'phenotype_root',value:'OBO:UPHENO_0001001'});
...
web.wrapRouteGet(app, '/phenotype/:id.:fmt?', '/phenotype/{id}.{fmt}', ['id', 'fmt'], phenotypeByIdHandler);
web.wrapRouteGet(app, '/phenotype/:id', '/phenotype/{id}', ['id'], phenotypeByIdHandler);
...
web.wrapRouteGet(app, '/disease/:id/:section', '/disease/{id}/{section}', ['id', 'section'], diseaseByIdSectionHandler);

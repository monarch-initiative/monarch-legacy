...
var fetchModelPage = function(request, id, fmt) {
    try {
        ...
        addGolrTable(info, "object_closure", id, 'disease-table', disease_filter, 'model_disease');
        ...
        addGolrTable(info, "object_closure", id, 'gene-table', gene_filter, 'model_gene');
    
        var variant_filter = { field: 'subject_category', value: 'variant' };
        addGolrTable(info, "object_closure", id, 'variant-table', variant_filter, 'model_variant');
...
app.get('/phenotype/:id.:fmt?',
        function(request, id, fmt){
            ...
            //Load variables for client side tables
            var disease_filter = { field: 'subject_category', value: 'disease' };
            addGolrTable(info, "object_closure", id, 'disease-table', disease_filter, 'phenotype_disease');
            
            var gene_filter = { field: 'subject_category', value: 'gene' };
            addGolrTable(info, "object_closure", id, 'gene-table', gene_filter, 'phenotype_gene');
            ...
            var variant_filter = { field: 'subject_category', value: 'variant' };
            addGolrTable(info, "object_closure", id, 'variant-table', variant_filter, 'phenotype_variant');
...
app.get('/disease/:id.:fmt?',
        ...
        try {
            ...
            var gene_filter = { field: 'subject_category', value: 'gene' };
            addGolrTable(info, "object_closure", id, 'gene-table', gene_filter, 'disease_gene');
            
            var model_filter = { field: 'object_category', value: 'model' };
            addGolrTable(info, "subject_closure", id, 'model-table', model_filter, 'disease_model');
            
            var variant_filter = { field: 'subject_category', value: 'variant' };
            addGolrTable(info, "object_closure", id, 'variant-table', variant_filter, 'disease_variant');
...
var fetchFeaturePage = function(request, id, fmt) {
    try {
        ...
        var variant_filter = { field: 'subject_category', value: 'variant' };
        addGolrTable(info, "object_closure", id, 'variant-table', variant_filter, 'gene_variant');

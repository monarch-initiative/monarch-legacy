...
app.get('/association/:id.:fmt?',
        ...
        try {
          ...
          //Curify ID if needed
            ...
            //Load variables for client side tables
            addGolrTable(info, "evidence_object_closure", id, 'associations-table', undefined, 'generic_association');
            info.associationNum = engine.fetchAssociationCount(id, 'evidence_object_closure');
            
            var association_table = {href: "associations", div: "associations-table"};
            info.includes.assoc_table = Mustache.to_html(getTemplate('golr-table'), association_table);

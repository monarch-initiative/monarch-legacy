...
app.get('/gene', function(request) {
    ...
    var phenotypes = info.spotlight.phenotypes.map(function(p) genObjectHref('phenotype',p));
    ...
    var diseases = info.spotlight.diseases.map(function(p) genObjectHref('disease',p));

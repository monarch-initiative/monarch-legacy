...
app.get('/labs/widget-scratch/phenotype/:id.:fmt?',
	    ...
	    var golr_conf_json = JSON.parse(golr_conf_raw);
            ...
            engine.log("Passing PhenotypeID= "+id);

            info.monarch_launchable = [];
            info.monarch_launchable.push('getOntologyBrowser(queryID);');
            info.monarch_launchable.push('getTableFromSolr(queryID);');
...
// DUMB REPEATED CODE JUST FOR TESTING
app.get('/labs/widget-scratch/disease/:id.:fmt?',
	    ...
	    var golr_conf_json = JSON.parse(golr_conf_raw);
            ...
            info.pup_tent_js_variables.push({name:'queryID', value: id});
            info.pup_tent_js_variables.push({name:'query_field', value: "subject_closure"});
            info.pup_tent_js_variables.push({name:'global_solr_url',
					     value: engine.config.golr_url});
            info.pup_tent_js_variables.push({name:'global_golr_conf',
					     value: golr_conf_json});

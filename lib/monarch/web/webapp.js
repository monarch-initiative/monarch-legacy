...
app.get('/labs/blog-scratch:page?', function(request, page){
    ...
    info.monarch_home_test_a_p = false;
    info.monarch_home_test_b_p = false;
    info.monarch_home_test_c_p = false;
    if( page ){
	if( page == '-exp-a' ){
	    info.monarch_home_test_a_p = true;
	}else if( page == '-exp-b' ){
	    info.monarch_home_test_b_p = true;
	}else if( page == '-exp-c' ){
	    info.monarch_home_test_c_p = true;
	}
    }

...
app.get('/widgets/phenogrid/js/:page', function(request,page) {
    return serveDirect('widgets/phenogrid/js',page,'text/html');
});

app.get('/widgets/phenogrid/js/:page', function(request,page) {
    return serveDirect('widgets/phenogrid/js',page,'text/plain');
});*/
...
app.get('/widgets/phenogrid/image/:page', function(request,page) {
 ...
 app.get('/widgets/datagraph/js/:page', function(request,page) {
     return serveDirect('widgets/datagraph/js',page,'text/javascript');
 });
 app.get('/widgets/datagraph/css/:page', function(request,page) {
     return serveDirect('widgets/datagraph/css',page,'text/css');
 });
// Method: search
//
...
try {
        ...
        return response.html(Mustache.to_html(getTemplate('sources'), info));
    }
    catch(err) {
        return errorResponse(err);
    }
...
app.get('/labs/datagraph.:fmt?',function(request,fmt){
	    ...
	    addCoreRenderers(info);
	    info.scripts.push({"url" : '/widgets/datagraph/js/datagraph.js'});
	    info.stylesheets.push({"url" : "/widgets/datagraph/css/datagraph.css"});
	    info.stylesheets.push({"url" : "/css/monarch-labs.css"});
	    info.stylesheets.push({"url" : "/css/monarch-specific.css"});
	    info.stylesheets.push({"url" : "/css/main.css"});
	    info.stylesheets.push({"url" : "/css/monarch-main.css"});

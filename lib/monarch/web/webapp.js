...
var fetchGenericSection =  function(request, id, section, fmt) {

    var info = engine.fetchDataInfo(id);
...
var fetchModelPage = function(request, id, fmt) {
    try {
        ...
        addGolrScratchInfo(info, "object_closure", id, 'disease-table', disease_filter );
        ...
        addGolrScratchInfo(info, "subject_closure", id, 'model-table', variant_filter );
    
        var variant_filter = { field: 'subject_category', value: 'variant' };
        addGolrScratchInfo(info, "object_closure", id, 'variant-table', variant_filter );
    
        var pathway_filter = { field: 'object_category', value: 'process' };
        addGolrScratchInfo(info, "subject_closure", id, 'pathway-table', pathway_filter );
...
app.get('/genotype/:id./:section.:fmt?',fetchGenericSection);
...
app.get('/model/:id/:section.:fmt?', fetchGenericSection);


app.get('/legacy/model/:id.:fmt?', function(request, id, fmt) {
...
var fetchFeaturePage = function(request, id, fmt) {
    try {
        ...
        addGolrScratchInfo(info, "subject_closure", id, 'disease-table', disease_filter);

            ...
            get: function() {
                if (!postParams) {
                    ...
                    if (req.headers['content-length'] > 50000000){
                        ...
                        parseFileUpload(this, postParams, encoding, TempFileFactory, byte_limit);
                    } else if (desc) {
...
app.get('/labs/gene/:id.:fmt?', function(request, id, fmt) {
 ...
 /**
  * Overriding parseFileUpload from ringo/http
  * See note above in upload function, we override this to implement a limit when
  ...
  */
 function parseFileUpload (request, params, encoding, streamFactory, lim) {

...
function _decide_content_encoding(ctype){
    ...
    else if (ctype === 'application/x-font-truetype') {
        encoding = 'binary';
    }
    else if (ctype === 'application/font-woff') {
        // encoding = 'binary';
    }
    else if (ctype === 'application/font-woff2') {
        // encoding = 'binary';
    }
...
function addModelTableWithFilter() {
    var model_table = {href: "models", div: "model-table"};
    return expandTemplate('golr-table-filter', model_table);
}

...
bbop.monarch.Engine.prototype.fetchPhenotypeInfo = function(id, opts) {
    ...
    for (var i = 0; i < obj.disease_associations.length && i < 30; i++) {
...
bbop.monarch.Engine.prototype.generateHistogram = function(id,levels,isCached,filter) {
    ...
    Object.keys(hp_labels).forEach(function(category) {
        ...
        resources.forEach(function(resource) {
    	    ...
    	    /*var resultObj = engine.fetchDataFromResource(category,resource.id,
    	                                               null,null,
    					                               subclassQuery);*/
    		var resultObj={};
    		try {
    			...
    			console.log("caught exception "+err+"for "+url);
    		}
    		if (resultObj.result){
    		    var d3Bar = {
    				         "value" : resultObj.result.resultCount,
    				         "name" : resource.label
    		                };

 ...
 * 
 */
bbop.monarch.Engine.prototype.fetchAssociations = function(id, field, filter, limit, personality) {
    var engine = this;
...
bbop.monarch.Engine.prototype.fetchAssociationCount = function(id, field, filter, personality) {
    var golrResponse = engine.fetchAssociations(id, field, filter, 0, personality);

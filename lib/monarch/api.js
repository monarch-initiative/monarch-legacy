...
bbop.monarch.Engine.prototype.fetchClassInfo = function(id, opts) {
    ...
    if (opts != null) {
        if (opts.level != null && opts.level > 0) {
            ...
            resultObj.equivalentClasses = equivalentClasses;
        }
    }
...
bbop.monarch.Engine.prototype.fetchDataInfo = function(id, opts) {
    ...
    resultObj.equivalentClasses = engine.getEquivalentClasses(id, graph);
    ...
    if (taxon){
        resultObj.taxon = engine.mapSpeciesIdentifierToTaxon(taxon.replace('NCBITaxon:',''));
    }

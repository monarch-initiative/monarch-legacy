...
bbop.monarch.Engine.prototype.fetchPhenotypeInfo = function(id, opts) {
    ...
    for (var i = 0; i < obj.disease_associations.length; i++) {
        var disease = obj.disease_associations[i].disease;
        genes = genes.concat(engine.fetchDiseaseGeneAssociations(disease.id));
    }
    obj.gene_associations = genes;

...
bbop.monarch.Engine.prototype.fetchMgiGenoPhenoAsAssocations = function(id) {
    ...
    var tr =
        function (r) {
            var obj = {
                id : "MGI:" + r.mgi_annotation_id, // TODO - check this is unique across all of MGI
                evidence : { 
                    type : {
                ...
                has_genotype : 
                {
                    ...
                    background : { id : r.background_strain_id,
...
bbop.monarch.Engine.prototype.searchOverOntologies = function(term, opts) {
    ...
    for (var k in classes) {
        var cx = classes[k];
        console.log("C="+cx);
        var c = this._translateClassXml(cx);        
        results.push(c);
    }
...
bbop.monarch.Engine.prototype._translateOntoQuestXmlToJson = function(xmlStr) {
    ...
    if (xml != null) {
        ...
        info = this._translateClassXml(c);
    }
    return info;
}

bbop.monarch.Engine.prototype._translateClassXml = function(c) {
    var info = {};
    if (c == null) {
        return null;
    }

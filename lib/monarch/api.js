 ...
 * 
 * Below are a number of functions, mostly untested, that are developed
 * to work with scigraph and solr/golr services.
 * 
 */
...
bbop.monarch.Engine.prototype.fetchAssociations = function(id, field, filter, limit) {
    ...
    golrManager.set_personality('simple_association');
    ...
    if (typeof filter !== 'undefined' && filter.field && filter.value){

...
bbop.monarch.Engine.prototype.fetchClassInfo = function(id, opts) {
    ...
    if (opts != null) {
        if (opts.level != null && opts.level > 0) {
            ...
            var equivalentClasses = engine.getEquivalentClasses(id, ontoGraph);
            equivalentClasses.forEach( function (i) {
                if (resultObj.database_cross_reference.indexOf(i) == -1){
                    resultObj.database_cross_reference.push(i);
                }
            });
        }
    }
...
bbop.monarch.Engine.prototype.fetchDataInfo = function(id, opts) {
    ...
    equivalentClasses = engine.getEquivalentClassList(id, server);
    equivalentClasses.forEach( function (i) {
        if (resultObj.database_cross_reference.indexOf(i) == -1){
            resultObj.database_cross_reference.push(i);
        }

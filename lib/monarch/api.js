...
//        "nlx_152525-2",
    ...
    // load exomiser-core library
    addToClasspath(module.resolve("../../../modules/exomiser-core-5.2.0.jar"));
    importPackage(Packages.org.monarchinitiative.exomiser.core.util);
}
    ...
    if (trFunction){
        if (sciObj instanceof Array){
            ...
            if (sciObj.list){
				...
				if (typeof sciObj.paths != 'undefined') {
...
bbop.monarch.Engine.prototype.pingExomiser = function() {
    var p = new Packages.org.monarchinitiative.exomiser.core.util.Ping();

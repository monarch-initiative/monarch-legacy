...
var golrManager = null;
var searchGolrManager = null;
 ...
 */
 bbop.monarch.Engine.prototype.autocomplete = function(term,categories,limit) {
    ...
    if(searchGolrManager == null) {
        searchGolrManager = engine.initializeGolrManager("monarch_search", this.config.search_url);
    }
...
bbop.monarch.Engine.prototype.fetchAssociations = function(id, field, filter, limit, personality, facet) {
    ...
    if(golrManager == null) {
        golrManager = engine.initializeGolrManager(personality);
    }

 ...
 */
 bbop.monarch.Engine.prototype.autocomplete = function(term, category, limit) {
    ...
    searchGolrManager.set_query(term);
    // @kshefchek - replace after prod is updated with new index with:
    // searchGolrManager.add_query_filter_as_string("-fq=prefix:OMIA")
    searchGolrManager.add_query_filter_as_string("-fq=id:OMIA*")

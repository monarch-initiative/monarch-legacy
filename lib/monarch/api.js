...
bbop.monarch.Engine.prototype.getPhenotypes = function(id_list) {
    ...
    for (var it=0; it<id_list.length; it++) {
        ...
        phenotype_list = engine.filterPhenotypeList(phenotype_list);
...
bbop.monarch.Engine.prototype.searchOverOntologies = function(term, opts) {
    ...
    // Fetch taxon
    var filtered_list = results.filter(function(i) { return i.categories.indexOf('gene') > -1; });
    var non_gene_list = results.filter(function(i) { return i.categories.indexOf('gene') == -1; });
    var non_gene_ids = non_gene_list.map(function(i) { return i.id; });
    non_gene_ids.forEach(function (id) {
    ...
    var id_list = filtered_list.map(function(i) { return i.id; });
 ...
 * 
 */
bbop.monarch.Engine.prototype.fetchSectionInfo = function(id) {
    var engine = this;

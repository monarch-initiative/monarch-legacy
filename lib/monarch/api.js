...
bbop.monarch.Engine.prototype.getVocabularyTermByID = function(id) {
    
    var params = null; //No parameters for this operation
    var path = "vocabulary/id/"+id+'.json';
    var resultObj = [];
    
    resultObj = this.querySciGraphVocabServices(path,params);
    return resultObj;
}
...
bbop.monarch.Engine.prototype.querySciGraphVocabServices = function(path,params) {
...
bbop.monarch.Engine.prototype.fetchCoreDiseaseInfo = function(id) {
    ...
    var golrResponse = engine.fetchAssociations(id, 'subject_closure', filter, 50000); //test, delete if still here

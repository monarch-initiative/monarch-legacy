...
bbop.monarch.Engine.prototype.fetchPhenotypeInfo = function(id, opts) {
	...
	//these worm associations are not genotypes!  they are actually variants, and it's odd to put them here
	//TODO - fetchSequenceAlterationPhenoAsAssociationsBySpecies(id,'6239','phenotype');
...
bbop.monarch.Engine.prototype.fetchOmimDiseasePhenotypeAsAssocations = function(id, opts) {
    ...
    if (idtype == 'disease') {
		...
		console.warn("No type supplied.  Assuming phenotype id");

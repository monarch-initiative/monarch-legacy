...
bbop.monarch.Engine.prototype.fetchGeneInfo = function(id, opts) {
 ...
 // PHENOTYPES
    var resultObj = this.fetchGeneDiseaseAsAssociation(gene.id);
    phenotype_associations = phenotype_associations.concat(resultObj.results);
...
bbop.monarch.Engine.prototype.fetchGeneDiseaseAsAssociation = function(id) {
...
bbop.monarch.Engine.prototype.fetchGeneInfoFromMyGene = function(id) {
    ...
    if (id.match(reg)){
        ...
        ret = this.fetchUrl(mygene_url + 'query?q=mim:' + geneID + "&species=human,mouse,rat,zebrafish,fruitfly,worm");
        ret = JSON.parse(ret);
    } else {
    	ret = this.fetchUrl(mygene_url + 'query?q=' + id + "&species=human,mouse,rat,zebrafish,fruitfly,worm");
        ret = JSON.parse(ret);
    }

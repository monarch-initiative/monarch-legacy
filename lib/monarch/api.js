...
bbop.monarch.Engine.prototype.searchSubstring = function(term, opts) {
    ...
    var results = engine.getVocabularyByTerm(term,searchType,limit,null,null,null,tr);
    var filtered = [];
...
bbop.monarch.Engine.prototype.searchOverOntologies = function(term, opts) {
    ...
    results = engine.getVocabularyByTerm(term,searchType,limit,null,null,null,tr);

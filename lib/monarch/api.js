...
bbop.monarch.Engine.prototype.fetchGeneInfo = function(id, opts) {
    ...
    if (obj.source == "NOT FOUND") {
        ...
        gene = {
            ...
            label : obj.symbol,
            location : obj.map_location,
            description : obj.name,
            taxon : { id : obj.taxid },
            references : [
                // 'NCBI_gene:'+obj.entrezgene,
                // 'Ensembl_gene:'+obj.ensembl.gene,
                 "PMID:20301714"
            ],
 ...
 // PHENOTYPES
    ...
    for (var i=0; i<phenotype_associations.length; i++){
    	//For human disease phenotype relationships
    	if (phenotype_associations[i].disease.id){
    	    disease_associations = disease_associations.concat(phenotype_associations[i]);
    	}
    }

...
bbop.monarch.Engine.prototype.filterXrefsForGene = function(geneMap,references) {
	...
	//TODO necessary?
	//This should be here (it is used in the for loop below)
	//It just filters out duplicate Ensembl IDs from mygene and nif
	//Should we remove ensembl ID from mygene?
	var unique = {};
	if (references){

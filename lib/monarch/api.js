...
bbop.monarch.Engine.prototype.fetchOrthologList = function(ids) {
    ...
    ids.forEach(function(id) {
        var orthoObj = engine.fetchGeneOrthologAsAssociation(id,'label',id, true);
 ...
 * 
 */
bbop.monarch.Engine.prototype.fetchGeneOrthologAsAssociation = function(id,label,ncbiID, noMap) {

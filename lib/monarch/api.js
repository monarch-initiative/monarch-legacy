...
bbop.monarch.Engine.prototype.searchByPhenotypeProfile = function(query,target_species,target_type,cutoff,metric) {
    ...
    var species_to_filter_map = {
	    ...
	    'UDPICS': { label :'UDPICS',target_idspace: 'UDPICS', b_type:'UDPICS patients',b_source: 'udpics'}
    };
...
bbop.monarch.Engine.prototype.fetchClassInfo = function(id, opts) {
    ...
    resultObj = {};
    if (typeof res.concepts[0] != 'undefined'){
    ...
    if (opts != null) {
        if (opts.level != null && opts.level > 0) {
            ...
            var paths = rel; //HACK FOR KATO REFACTOR OUT
            
            var idMap = {};
            var triples = [];
              
			if (typeof rel != 'undefined' ) {
			    //HACK FOR KATO REFACTOR OUT
			    if (typeof rel.paths != 'undefined'){
                paths.paths.forEach(function(rel){ //END HACK
				if (typeof rel.nodes != 'undefined') {
					rel.nodes.forEach(function(k){
						idMap[k.id] = k.lbl;
					});
				}
				if (typeof rel.edges != 'undefined') { 
			...
			else {  // THIS SHOULD WORK FOR GEOFFREY, NEED TO REFACTOR TO USE BBOP GRAPH
			    if (typeof rel.nodes != 'undefined') {
                    rel.nodes.forEach(function(k){
                        idMap[k.id] = k.lbl;
                    });
...
bbop.monarch.Engine.prototype.getEquivalentClassList = function(id,level) {
    ...
    if (typeof rel != 'undefined' && typeof rel.edges != 'undefined') { 
		rel.edges.forEach(function(k) {
			var equivClass;
...
bbop.monarch.Engine.prototype.getGraphNeighborsExtend = function (id, depth, relationship, direction){
    ...
    var path = "graph/neighbors/"+id+'.json';
    var resultObj = this.querySciGraphOntologyServices(path,params);
    return resultObj;
}

...
bbop.monarch.Engine.prototype.fetchClassInfo = function(id, opts) {
    ...
    if (opts != null) {
        if (opts.level != null && opts.level > 0) {
            ...
            if (typeof rel.status == 'undefined'){   
 ...
 */
bbop.monarch.Engine.prototype.fetchUrlWithPacket = function(url, params, method) {
    var data = '';
    if (params == null) {
        params = {};
    }
...
bbop.monarch.Engine.prototype.querySciGraph = function(uri,params,trFunction) {
    ...
    //Fetch URI
    var exchangeObj = engine.fetchUrlWithPacket(uri,params);

 ...
 *
 * Example:
 * http://beta.neuinfo.org/services/v1/literature/pmid?pmid=22080565,%2022080566
 */
bbop.monarch.Engine.prototype.fetchPubFromPMID = function(id) {
    var urlBase = this.config.literature_services_url;    
    var resultXML = this.fetchUrl(urlBase + "pmid?pmid=" + id);
//     var pubObj = this.parseXML(resultXML);
    return resultXML;
}

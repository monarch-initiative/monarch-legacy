...
bbop.monarch.Engine.prototype.fetchOmimDiseasePhenotypeAsAssocations = function(id) {
    ...
    if (idtype == 'disease') {
        filters['disorder_id'] = id;
    } else if (idtype == 'phenotype') {
		filters['phenotype_id'] = id;
	}
    filters["aspect"] = "O";
...
bbop.monarch.Engine.prototype.searchByPhenotypeProfile = function(query,target_species,target_type,cutoff,metric) {
    ...
    if (typeof target_species !== 'undefined' && target_species != '' && target_species != null) {
      ...
      resource = species_to_filter_map[target_species];
    } else {
...
bbop.monarch.Engine.prototype.generateHistogram = function() {
    ...
    var hp_labels = {};
    var nif_id = this.getOntoquestNifId("HP:0000118");
    ...
    */
    ...
    //Sort results
    /*for (var i=0, len=dataGraph.length; i < len; i++){
    	for (var y=0, len=dataGraph.length; y < len; y++){
    	    if (dataGraph[y].counts[1].value < dataGraph[i].counts[1].value){
    	        var temp = dataGraph[i];
    	        dataGraph[i] = dataGraph[y];
    	        dataGraph[y] = temp;
    	    } 
        }
    }*/
    dataGraph.sort(function(obj1, obj2) {
    	return obj1.counts[1].value - obj2.counts[1].value;
    });
    dataGraph.reverse();

...
bbop.monarch.Engine.prototype.fetchGenoPhenoAsAssociationsBySpecies = function(id,sp,type) {
    ...
    var species_to_resource_map = {
        '10090' : {resources : [{id:'nif-0000-00096-6',label:'MGI'},{id:'nif-0000-03160-2',label:'MPD'}],   default_taxon : {id : 'NCBITaxon:10090',label : 'Mus musculus'}},
...
//TODO remove OMIM, not genotype
    ...
    for (var i=0; i<resources.length; i++) {
		...
		if (type == 'phenotype') {
			...
			resultObj = engine.fetchDataFromResource(id,resource.id,tr);
		}

...
if (typeof bbop.monarch == 'undefined') {
    bbop.monarch = {};
}
exports.bbop = bbop;
...
bbop.monarch.Engine.prototype.fetchUrlWithExchangeObject = function(url, params, method) {
    ...
    if (env.isRingoJS()) {
        ...
        var requestType = AsyncRequest.get;
        var requestMethod = method;
        if (url === 'http://owlsim.monarchinitiative.org/searchByAttributeSet') {
            console.log('MANUALREDIRECT[' + method + ']');
        }
        ...
        if (method === 'post') {
            ...
            requestType = AsyncRequest.post;
        }
        else {
            requestOptions.method = 'GET';
            requestOptions.qs = params;
            requestOptions.useQuerystring = true;
            requestType = AsyncRequest.get;
        }


        console.log('### requestMethod', requestMethod);
        var res = WaitFor.for(AsyncRequest, requestOptions);
        ...
        console.log('fullurl: ', url + '?' + querystring.stringify(params));

...
bbop.monarch.Engine.prototype.fetchGenePhenotypeAsAssociation = function(id,gene,tax) {
    ...
    if (typeof tax != 'undefined' && Object.keys(tax) != null) {
...
bbop.monarch.Engine.prototype.compareEntities = function(x,y) {
	...
	for (var it=0; it<y.length; it++) { 
		...
		var resultObj = engine.fetchAttributeComparisonMatrix(x,target);
		if (resultObj != null && resultObj.results != null) {
	...
	var a = {id : x, label : engine.getLabel(x), type : engine.mapIdentifierType(x)};

    ...
    if (gene.ncbi_id){
        ...
        var fetchOrg = 
            this.fetchDataFromResource(null,
                    resource_id,null,null,filters,null,null,{useClosure : false }
                );
...
//	var filters = ["source:NCBIGene","mapped_id:"+this.quote(this.getFederationNifId(id))];
    ...
    var resultObj = this.fetchDataFromResource(null, resource_id, tr,null,filters,null,null,{ useClosure : false});
...
//		var filters = ["gene_id:"+this.quote("NCBIGene:"+id)];
    	...
    	var keggGeneToKO = this.fetchDataFromResource(null,kegg_ko_map_resource_id, keggtr, null, filters,null,null,{useClosure : false});

...
bbop.monarch.Engine.prototype.fetchGeneOrthologAsAssociation = function(id,label,genObj) {
    ...
    var filter = ["genea:" +this.quote(id)];

    var tr =
        function (r) {
    	
    	//if (r.geneb.match(/^MGI:MGI:/)){
        //    r.geneb = r.geneb.replace(/MGI:MGI:/,'MGI:');
        //} 
        ...
        if ((source == 'human')||(source == 'WB')){
        	...
        	tr =
                ...
                var obj = {
                  ...
                  allele : { 
                      id : r.implicated_sequence_alteration_ids,
                      label : r.implicated_sequence_alteration_labels
                  },
        ...
        if (resultObj){
        	for (var i=0; i<resultObj.results.length; i++){
        		...
        		if (cat in unique){
                	...
                	//to the query gene
                	if (resultObj.results[i].allele.id.match(/\,/)){
                		continue;
                	}

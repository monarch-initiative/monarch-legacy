...
//        return errorResponse(err);
    ...
    //Test scigraph function
    console.log("Fetch class foo info output" + JSON.stringify(obj));
    var trFunction = function (r) {
    	var obj = {'id' : r.nodes[0].id};
    	return obj;};
    var foo = this.getGraphNeighbors(id,'1',trFunction);
    console.log("my function" + JSON.stringify(foo));
...
bbop.monarch.Engine.prototype.getVocabularyByID = function(id,trFunction) {
	...
	var path = "vocabulary/id/"+term+'.json';
	var uri = this.config.scigraph_url+path;
	var sciObj;
    var resultObj = [];
    var resultStr;

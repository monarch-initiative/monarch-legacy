 ...
 */
bbop.monarch.Engine.prototype.fetchDiseaseGeneAssocsInfo = function(id, opts) {
    var engine = this;
    if (this.cache != null) {
        var cached = this.cache.fetch('disease', id);
        if (cached != null) {
        ...
        return engine.fetchDiseaseGeneAssociations(id);
    }
}
...
bbop.monarch.Engine.prototype.fetchPhenotypeInfo = function(id, opts) {
    ...
    for (var i = 0; i < obj.disease_associations.length; i++) {
        ...
        genes = genes.concat(fetchDiseaseGeneAssocsInfo(disease.id));
    }

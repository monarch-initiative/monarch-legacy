...
result_weights: subject^7.0 subject_taxon^6.5 relation^6.0  object^5.0 object_taxon^4.2 evidence^4.0 evidence_object^3.7 source^3.5

## Ordering of facets, vertical
filter_weights: relation_closure_label^6.5 evidence_closure_label^6.0 evidence_object_closure_label^5.0 subject_closure_label^4.5 object_closure_label^4.0 subject_taxon_closure_label^3.5 object_taxon_closure_label^3.0
